...
if(typeof kkplay.define === 'function' && kkplay.define.amd) {
    kkplay.define('vendor/inherit',['require','exports','module'],function(require, exports, module) {
        module.exports = inherit;
    });
    defineAsGlobal = false;
}
...
(function (root, factory) {
    if (typeof kkplay.define === 'function' && kkplay.define.amd) {
        ...
        //the closure below.
        kkplay.define('h5_player',['vendor/inherit','player'], factory);
    } else {
...
(function (root, factory) {
    if (typeof kkplay.define === 'function' && kkplay.define.amd) {
        ...
        //see this AMD call, not the internal modules in
        //the closure below.
        kkplay.define('flash_player',['vendor/inherit','player'], factory);
    } else {
        //Browser globals case. Just assign the
        //result to a property on the global.
...
kkplay.define("app/play_page/player", function(){});
...
console.info('main loaded!')
    ...
    kkplay.require(['app/play_page/player','app/play_page/statistics'],function(){

    });



kkplay.define("app/play_page/main", function(){});
